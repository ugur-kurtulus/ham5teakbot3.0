...
from utils.views import Confirm, OPVerification

# ------- STARTUP EVENT -------
@client.event
async def on_shard_ready(shardid):
    print(f"Shard {shardid} has started.")
...
╰╯ ╰┻╯╰┻┻┻┻━━━┻━┻━━┻╯╰┻╯╰╯  ╰━━━┻━━┻━╯  ╰━━━┻ ╰╯╰━━━╯
    ...
    if not persistent_views_added:
        client.add_view(OPVerification())
...
>>>>>>> Stashed changes
    ...
    for embed in embeds:
        pages.append(embed)
    await channel.send(embed=pages[0], view=Confirm())
